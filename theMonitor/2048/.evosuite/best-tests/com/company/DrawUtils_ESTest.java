...
public class DrawUtils_ESTest extends DrawUtils_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      Font font0 = mock(Font.class, new ViolatedAssumptionAnswer());
      Rectangle2D rectangle2D0 = mock(Rectangle2D.class, new ViolatedAssumptionAnswer());
      doReturn((-1302.69)).when(rectangle2D0).getWidth();
      FontMetrics fontMetrics0 = mock(FontMetrics.class, new ViolatedAssumptionAnswer());
      doReturn(rectangle2D0).when(fontMetrics0).getStringBounds(anyString() , any(java.awt.Graphics.class));
      Graphics2D graphics2D0 = mock(Graphics2D.class, new ViolatedAssumptionAnswer());
      doReturn(fontMetrics0).when(graphics2D0).getFontMetrics();
  ...
  public void test3()  throws Throwable  {
      Font font0 = Font.decode("x:z");
      AffineTransform affineTransform0 = AffineTransform.getRotateInstance((-1034.83615), 1.0, 0.0);
      FontRenderContext fontRenderContext0 = new FontRenderContext(affineTransform0, false, false);
      Graphics2D graphics2D0 = mock(Graphics2D.class, new ViolatedAssumptionAnswer());
      doReturn(fontRenderContext0).when(graphics2D0).getFontRenderContext();
      int int0 = DrawUtils.getMessageHeight("x:z", font0, graphics2D0);
      assertEquals(6, int0);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      try { 
        DrawUtils.getMessageHeight("\"{u1P^9&k7", font0, graphics2D0);
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        DrawUtils.getMessageHeight("m#ZoL#G})y", font0, graphics2D0);
  ...
  public void test7()  throws Throwable  {
      Graphics2D graphics2D0 = mock(Graphics2D.class, new ViolatedAssumptionAnswer());
      int int0 = DrawUtils.getMessageHeight("", (Font) null, graphics2D0);
      assertEquals(0, int0);
  }
  ...
  public void test9()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        DrawUtils.getMessageWidth("a", font0, graphics2D0);
        fail("Expecting exception: NullPointerException");
